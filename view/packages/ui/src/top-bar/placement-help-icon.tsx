...
const HELP_ITEMS_BASE = [
  { key: "Pan", text: "Move the map to position the sensor" },
  { key: "Confirm", text: "Save the position at map center" },
];

const HELP_ITEMS_WEB = [...HELP_ITEMS_BASE, { key: "Esc", text: "Cancel placement" }];

const HELP_ITEMS = Platform.OS === "web" ? HELP_ITEMS_WEB : HELP_ITEMS_BASE;

export function PlacementHelpIcon() {
  ...
  return (
    <View className="relative">
      <Pressable
        ...
        className="p-0.5"
      >
        <Info size={14} strokeWidth={1.5} color={t.placementAccent} />
      </Pressable>
      {showTooltip && (
        <View
